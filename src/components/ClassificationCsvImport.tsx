  ...
  return (
    <section className="panel mt-8 rounded-2xl p-6 sm:p-8">
      ...
      <div className="mt-5 rounded-xl border border-gold/40 bg-amber-50 p-4 text-sm text-stone-800">
        ...
        <code className="mt-2 block overflow-x-auto text-xs">id,name,soup_category,style_category</code>
        <p className="mt-2">id・nameは ramen_shops、分類欄は classification_training_examples の形式です。ローカル環境で soup_category と style_category を入力してから取り込んでください。旧形式の classification_text 列も読み込めます。</p>
      </div>
