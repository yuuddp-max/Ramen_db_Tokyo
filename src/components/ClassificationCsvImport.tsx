  ...
  return (
    <section className="panel mt-8 rounded-2xl p-6 sm:p-8">
      ...
      <div className="mt-5 rounded-xl border border-gold/40 bg-amber-50 p-4 text-sm text-stone-800">
        ...
        <code className="mt-2 block overflow-x-auto text-xs">id,classification_text,soup_category,style_category</code>
        <p className="mt-2">CSV出力直後は分類欄が空欄です。ローカル環境で soup_category と style_category を入力してから取り込んでください。idで店舗を特定し、店舗名から内部ハッシュを計算して登録します。</p>
      </div>
