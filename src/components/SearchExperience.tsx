...
export function SearchExperience({ initialShops, initialTotal }: Props) {
  ...
  useEffect(() => {
    ...
    setSort(initialSort);
    if (initialView === "map" || initialView === "both") setView(initialView);
  ...
  }, [query, genre, soup, style, minRating, price, sort, favoriteOnly, favoriteIds, recentOnly, recentIds, openOnly, page, userLocation, initializedFromUrl]);
  ...
  }, [query, genre, soup, style, minRating, price, sort, openOnly, page, view, initializedFromUrl]);
