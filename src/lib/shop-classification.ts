...
import { SOUP_CATEGORIES, STYLE_CATEGORIES, type SoupCategory, type StyleCategory } from "@/lib/shop-classification-categories";

export { SOUP_CATEGORIES, STYLE_CATEGORIES } from "@/lib/shop-classification-categories";
export type { SoupCategory, StyleCategory } from "@/lib/shop-classification-categories";
...
const soupRules: KeywordRule<SoupCategory>[] = [
  ...
  { category: "カレー", keywords: ["カレー", "カレーラーメン"], excludeKeywords: [], priority: 80, score: 0.93 },
...
const styleRules: KeywordRule<StyleCategory>[] = [
  ...
  { category: "背脂系", keywords: ["背脂", "せあぶら"], excludeKeywords: [], priority: 54, score: 0.90 },
